...
public void setCreationDate(Date creationDate) {
	propertyChangeSupport.firePropertyChange("creationDate", this.creationDate,
...
public void setIsMovedToArchive(Boolean isMovedToArchive) {
	  propertyChangeSupport.firePropertyChange("isMovedToArchive", this.isMovedToArchive,
